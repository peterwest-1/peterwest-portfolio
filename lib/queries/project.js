...
export const projectIndexWebQuery = `
*[_type == "project"  && category == 'web'] | order(date desc, _updatedAt desc) {
  ${projectFields}
}`;

export const projectIndexGeneralQuery = `
*[_type == "project"  && category == 'general'] | order(date desc, _updatedAt desc) {
  ${projectFields}
}`;
